const offer = document.querySelector("a.offer");
const divOne = document.querySelector('div#off1');

const navUs = document.querySelector("a.weare");
const divZero = document.querySelector("div#off0");

const contact = document.querySelector("a.contact");

navUs.addEventListener('click', ()=> {
...
const docs = document.querySelector("a.doc");
const divTwo = document.querySelector('div#off2');
